...
// lokalnie
//$tinybrowser['path']['image'] = '/zakladslusarskistach/img/gallery/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
//$tinybrowser['path']['media'] = '/zakladslusarskistach/img/gallery/'; // Media files location
//$tinybrowser['path']['file']  = '/zakladslusarskistach/img/gallery/'; // Other files location
//na serwerze
$tinybrowser['path']['image'] = '/img/gallery/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/img/gallery/'; // Media files location
$tinybrowser['path']['file']  = '/img/gallery/'; // Other files location
